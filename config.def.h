...
static const char *fonts[]          = { "EnvyCodeR Nerd Font:size=14" };
...
#define TAGKEYS(KEY,TAG) \
	...
	{ MODKEY|METAKEY|ShiftMask,     KEY,      tag,            {.ui = 1 << TAG} }, \
...
static const char *dmpass_name_cmd[] = { "dmpass", "--name", NULL };
...
static const char *dmhc_cmd[]        = { "dmhc", NULL };
...
static const char *alt_browser_cmd[] = { "librewolf", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_Return,                dmenuspawn,     {.v = dmbookm_cmd } },
	...
	{ 0,                            XF86XK_AudioMute,         spawn,          {.v = mic_cmd } },
	...
	{ MODKEY|ControlMask|ShiftMask, XK_h,                     swapwindow,     {.i = +1 } },
	{ MODKEY|ControlMask|ShiftMask, XK_l,                     swapwindow,     {.i = -1 } },
